    ...
    <div class="row main-content">
          ...
          <div class="menu-list">
            <ul id="menu-content" class="menu-content collapse out">
              ...
              <li data-toggle="collapse" data-target="#Admin" class="collapsed">
                <a href="#"><i class="fa fa-globe fa-lg"></i>Posts<span class="arrow"></span></a>
              </li>

              <li data-toggle="collapse" data-target="#Admin" class="collapsed">
                <a href="#"><i class="fa fa-globe fa-lg"></i>Coments<span class="arrow"></span></a>
              </li>
      ...
      <div class="question-content col-lg-9">
        ...
        <div class="panel panel-default" >
          ...
          <span >Enter The Reason Of Deactive user here </span>
          <div class="input-group" >
          ...
          <input type="submit" name="Deactive"class="btn btn-primary " value="Deactive" style="margin: 10px;">
        </div>
              </div>
              </div>
