...
$comm=Comment::find("all", array('order' =>'id asc'));
          ...
          <div class="panel-body" style=" background-color:  whitesmoke;">
              ...
              <!-- Default panel contents -->
                  ...
                  <table class="table table-striped">
                    <caption>Comments That Disapprove: </caption>
                    <thead>
                      <tr>
                        <th>title</th>
                        <th>content</th>
...
<td><?php echo $value->title;?></td>
 <td><?php echo $value->content;?></td>
  ...
  <td><?php  $Post=Post::find_by_id($value->post_id);  echo $Post->title;?></td>
  <td><?php   $usn=User::find_by_id($value->user_id);    echo $usn->fname ;?></td>
  <td></td>
   <td><a href="approvecomm.php?commid=<?php echo $value->id ?>"> <div id="mybtn" >approve</div><a></td>
   

 <td><a href="deletecoments.php?commid=<?php echo $value->id;?>"><img src="Css/Images/icons/delete.png"></a><td>
...
<td></td>
   <td><a href="disapprovecom.php?commid=<?php echo $value->id ?>">Disapprove<a></td>
