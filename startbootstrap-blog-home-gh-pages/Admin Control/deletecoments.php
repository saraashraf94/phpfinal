...
$comm=Comment::find_by_id($_GET["commid"]);
$comm->status="deleted";
    ...
    <div class="row main-content">
      ...
      <div class="question-content col-lg-9">
        ...
        <div class="panel panel-default" >
          ...
          <span >Enter The Reason Of Delete comments here :</span>
          <div class="input-group" >
          ...
          <input type="submit" name="Delete"class="btn btn-primary " value="Delete" style="margin: 10px;">
        </div>
              </div>
              </div>
