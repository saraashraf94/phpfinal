...
require_once"config.php";
 $users=User::find("all", array('order' =>'Fname asc'));
...
<tr>
 ...
 <font color="red"><td><?php echo $value->fname;?></td></font>
 <font color="red"> <td><?php echo $value->lname;?></td></font>
  <font color="red"> <td><?php echo $value->email;?></td></font>

   <td><a href="activeUser.php?userid=<?php echo $value->id ?>"><div id="mybtn" >active</div><a></td>
   

 <td><a href="deleteUser.php?userid=<?php echo $value->id;?>"><img src="Css/Images/icons/delete.png"></a><td>
...
<tr>
 ...
 <font color="red"> <td><?php echo $value->lname;?></td></font>
  <font color="red"> <td><?php echo $value->email;?></td></font>
   ...
   <td><a href="deactiveUser.php?userid=<?php echo $value->id ?>"><div id="mybtn" >decactive</div><a></td>
