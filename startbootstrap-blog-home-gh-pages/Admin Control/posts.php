...
$posts=Post::find("all", array('order' =>'id asc'));
        ...
        <div class="nav-side-menu">
          ...
          <div class="menu-list">
            <ul id="menu-content" class="menu-content collapse out">
              ...
              <li data-toggle="collapse" data-target="#Admin" class="collapsed">
                <a href="comments.php"><i class="fa fa-globe fa-lg"></i>Comments<span class="arrow"></span></a>
              </li>
          ...
          <div class="panel-body" style=" background-color:  whitesmoke;">
              ...
              <!-- Default panel contents -->
                  ...
                  <table class="table table-striped">
                    <caption>Posts That Disapprove: </caption>
                    <thead>
                      <tr>
                        <th>title</th>
                        <th>content</th>
...
<td><?php echo $value->title;?></td>
 <td><?php echo $value->content;?></td>
  ...
  <td><?php  $cat=Category::find_by_id($value->cat_id);  echo $cat->title;?></td>
  <td><?php   $usn=User::find_by_id($value->user_id);    echo $usn->fname ;?></td>
  <td></td>
   <td><a href="aprovePost.php?postid=<?php echo $value->id ?>"><div id="mybtn" >approve</div><a></td>
   

 <td><a href="deletePost.php?postid=<?php echo $value->id;?>"><img src="Css/Images/icons/delete.png"></a><td>
...
?>
 ...
 <div class="panel panel-default" style="    margin-top: 30px;">
              <table class="table table-striped" >
                    <caption>Post That Approve: </caption>
                    <thead>
                      <tr>
                        <th>title</th>
                        <th>content</th>
...
<td></td>
   ...
   <td><a href="disapprovepost.php?postid=<?php echo $value->id ?>">Disapprove<a></td>
