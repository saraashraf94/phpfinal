...
if($_POST||$_GET){
 ...
 if ( isset($_POST["catogryname"])){


    header("Location:1.php?namecatogry=$_POST[catogryname]");
 }
          ...
          <div class="menu-list">
            <ul id="menu-content" class="menu-content collapse out">
              ...
              <li data-toggle="collapse" data-target="#Exam" class="collapsed">
                <a href="catogry.php"><i class="fa fa-globe fa-lg"></i> Catogry<span class="arrow"></span></a>
              </li>  
                
              <li data-toggle="collapse" data-target="#Report" class="collapsed">
                <a href="usersContol.php"><i class="fa fa-globe fa-lg"></i>Users<span class="arrow"></span></a>
              </li>
              ...
              <a href="comments.php ">
              <li data-toggle="collapse" data-target="#Admin" class="collapsed">
                <i class="fa fa-globe fa-lg"></i>Comments<span class="arrow"></span>
              </li>
              </a>
      ...
      <div class="question-content col-lg-9">
        ...
        <div class="panel panel-default" >
          <div class="panel-body" style=" background-color:  whitesmoke;">
            <form cation="creatNewCatogry.php" method="post">
              <div >
                <label for="category" class="col-sm-2 control-label">Add Catogery </label>

               
                  <input type="text" name="catogryname" required>
              

              
              <input type="submit" name="nameCat" class="btn btn-primary col-sm-offset-2" data-toggle="modal" data-target="#questionDialog" style="margin-top: 30px width: 250px;" value="Create New Catogry">
               </form>
              ...
              <!-- Default panel contents -->
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
<?php
  foreach ($catogryarr as  $value) {
  if($value->status==0){
  ?>

<tr>
                        
 <td><input class="in" type="checkbox" value="" ><?php echo $value->title;?></td>
 <td><a href="deletcatogry.php?idCat=<?php echo $value->id;?>"><img src="Css/Images/icons/delete.png"></a><td>
